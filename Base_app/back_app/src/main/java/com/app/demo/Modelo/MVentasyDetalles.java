...
public class MVentasyDetalles {
	MVentas ventas;
	List<MDetalle_Ventas> detalles;
	public MVentasyDetalles() {
	}
	public MVentasyDetalles(MVentas ventas, List<MDetalle_Ventas> detalles) {
		this.ventas = ventas;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MVentasyDetalles other = (MVentasyDetalles) obj;
